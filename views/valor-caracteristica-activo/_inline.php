...
if( $model->primaryKey )
{
    ...
    $removeAttr = 'data-dynamic-relation-remove-route="' . 
        Url::toRoute(['valor-caracteristica-activo/delete', 'ValorCaracteristicaActivoID' => $model->ValorCaracteristicaActivoID]) . '"';
...
<div class="ValorCaracteristicaActivo-form form" <?= $removeAttr; ?>>
    <div class="basura">
        <?php print_r( $model->primaryKey ); ?>
    </div>
    <?php
        if ($model->isNewRecord){
    ?>
            <select id="<?php $frag.'[Nombre]' ?>" class="form-control">
                <?php
            ...
            <input type="text" class="form-control" placeholder="Valor" name="<?php $frag.'[Valor]' ?>" value="" />
    <?php        
        }
        else{
                ?>
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" name="<?php $frag.'[Valor]' ?>" value="<?php echo $model->Valor ?>"/>
                </div>  
            <?php  
        }
    ?>    
