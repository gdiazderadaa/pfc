...
if( $model->primaryKey )
{
    ...
    $removeAttr = 'data-dynamic-relation-remove-route="' . 
        Url::toRoute(['valor-caracteristica-elemento-hardware/delete', 'id' => $model->id]) . '"';
    $frag = "ValorCaracteristicaElementoHardware[{$model->primaryKey}]";
}
else
{
    $removeAttr = "";
    // new models must go under a key called "[new]"
    $frag = "ValorCaracteristicaElementoHardware[new][$uniq]";
}
...
<div class="ValorCaracteristicaElementoHardware-form form" <?= $removeAttr; ?>>
    <?php
    ...
    <?php        
                ...
                <div class="input-group">
                    <span class="input-group-addon" id="<?= $uniq ?>"><?php  echo $model->caracteristica->nombre; if($model->caracteristica->unidades)  echo  ' (' . $model->caracteristica->unidades . ')'; ?></span>
